...
public class TiledMap {
	...
	public TiledMap(int mapaLargura, int mapaAltura, int tileLargura, int tileAltura, String nomeTileSet, String nomeMapaMatriz) {
	...
	public void montarMapa() {
		...
		for (int i = 0; i < mapaLargura; i++) {
			for (int j = 0; j < mapaAltura; j++) {
				tile = (camada[i][j] != -1) ? (camada[i][j]) : 230;
	...
	public int[][] carregarMatriz(String nomeMapa) {
		...
		System.out.println(matz.length);
